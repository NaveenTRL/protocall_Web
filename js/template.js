var template = {
    subMenuTabHTML: function () {
        var html = '<a href="/{{subMenuTab-name}}" class="snap submenu-tab bg-color-green right f-sz-16 ptsans-light {{subMenuTab-name}} p-relative" data-type="page" data-submenu="{{subMenuTab-name}}">'
                ...
                + '<div class="cnt-blk inline-block v-align-mid" style="{{isSubMenuTabCountCl}}">(<span class="">{{subMenuTab-count}}</span>)</div>'
                + '</a>';
        return html;
    },
    ...
    subMenuBlk: function () {
        var html = '<div class="mb-submenu-in p-relative">'
                + '<div class="bcrum-lb-submenu clr-fl inline-block v-align-mid" style="width:98%;">'
                + '{{breadcrumb_block}}'
                + '</div>'
                + '<div class="tab-rb-submenu  inline-block v-align-mid" style="width:53%;">'
    ...
    incidentAlertFeedHMLT: function (alertDetailsValue, alertType) {
        ...
        if (localStorage.getItem("LOGIN_LABEL") == "Agency") {
            ...
            try {
                if (alertDetailsValue.alertStatusDetails.statusOfMatchedReleased == undefined) {
                    sessionStorage.isUnRead = "true";
                } else {
                    sessionStorage.isUnRead = "false";
                }
        ...
        if (sessionStorage.isUnRead == "true") {
            styleValue = "style='background-color:#beccd1;margin-left:7px;'";
        } else {
			styleValue = "style='margin-left:7px;'";
		}
        ...
        if (alertType == "incidentalert") {
            ...
            alertFeedHtml = '<div class="rg-block left p-relative" >'
                    + '<div class="feed-det bg-color-dblue p-relative   "' + styleValue + ' >'
                    + '<div class="feed-docs-pad p-relative t-left" style="margin-left:35px;margin-right:35px;padding-left:0px;padding-right:0px;">'
                    ...
                    + '<div class="t-center p-relative" style="left:20px;margin-right:71px;">'
                    + '<div class="doc-icon-box" >'
                    + '<div class="sprite-im text-icon doc-icon-placement">&nbsp;</div>'
                    + '</div>' + '<div class="doc-cnt-box"><span class="doc-count doc-count-placement"  style="margin-right: 5px; margin-top: 3px;">' + noOfOtherPartyRecordsCount + '</span></div>'
                    + '<div class="feed-menu-text" style="  margin-top: -6px;">Text</div>'
                    + '</div>'
                    + '</a>'
                    ...
                    + '<div class="t-center p-relative" style="left:35px;margin-right:71px;">'
                    + '<div class="doc-icon-box"  style="margin-left:3px;">'
                    + '<div class="sprite-im photos-icon doc-icon-placement">&nbsp;</div>'
                    + '</div>'
                    + '<div class="doc-cnt-box" style="  margin-left: 3px;"><span class="doc-count doc-count-placement" style="margin-right: 5px; margin-top: 3px;">' + noOfPictureRecord + '</span></div>'
                    + '<div class="feed-menu-text" style="  margin-top: -6px;  margin-left: -2px;">Photos</div>'
                    + '</div>'
                    + '</a>'
                    ...
                    + '<div class="t-center p-relative" style="left:53px;">'
                    + '<div class="doc-icon-box" >'
                    + '<div class="sprite-im voice-icon doc-icon-placement">&nbsp;</div>'
                    + '</div>'
                    + '<div class="doc-cnt-box"><span class="doc-count doc-count-placement" style="margin-right: 5px; margin-top: 3px;">' + noOfAudioRecordCount + '</span></div>' + '<div class="feed-menu-text" style="  margin-top: -6px;">Voice</div>'
                    + '</div>'
                    + '</a>'
                    + '</div>'
                    + '</div>'
            ...
            if (sessionStorage.isUnRead == "true") {
                styleValue = "style='background-color:#beccd1;margin-left:7px;'";
				 ...
				 styleValue = "style='margin-left:7px;'";
                        ...
                        console.log("policy changehghg--->",alertDetailsValue.alertDetails.policyChange);
            var policyrightSideFeed = template.rightSideFeed(alertDetailsValue, "Policy Alert");
            alertFeedHtml = '<div class="rg-block left p-relative" >' + '<div class="feed-det bg-color-dblue p-relative  "' + styleValue + '>'
                    + '<div class="feed-docs-pad p-relative docs-block t-left" style="margin-left:35px;padding-left:0px;padding-right:0px;">'
                    + '<a href="/changecoverage" class="snap feed-addRemove-block inline-block v-align-mid f-sz-14 opensans-regular f-color-green changeCoverage p-relative" data-type="changeCoverage" style="float: left;margin-left:0px !important;">'
                    + '<div class="t-center">'
    ...
    rightSideFeed: function (alertDetailsValue, alertType) {
        ...
        /* var styleValue = "style=''";
        if (sessionStorage.isUnRead == "true") {
            styleValue = "style='background-color:#beccd1'";
        } */



        console.log("alertDetails in feedsTemplateHTML", alertDetailsValue);
        var html = "", firstName = "", lastName = "", alertDate = "", alertTime = "", bDay = "", bDate = "", residentialCity = "", phoneNumber = "", feedUserEmail = "", alertFeedHtml = "", profilePicture = "", rightSideAlerFeedHTML = "", viewArchiveFeedHTML = "",feedUserId="";
        if (HOMEPAGERESPONSE.ISVIEWALERTVALUECLICKED) {
            ...
            if (alertDetailsValue.alertDetails.alertDate !== "undefined") {
                ...
                alertDate = moment.utc(Number(alDate)).format('MMM D, YYYY');
				alertTimeWithDST = moment.utc(Number(alDate))._d;
                alertTime = moment(alertTimeWithDST).format('h:mmA');
			...
			if (alertType == "incidentalert") {
				if(alertDetailsValue.IncidentDetails.incidentState != undefined){
					residentialCity = alertDetailsValue.IncidentDetails.incidentCity+","+alertDetailsValue.IncidentDetails.incidentState;
			...
			feedUserId = HOMEPAGERESPONSE.COMMONUSERDETAILS.userId;
            ...
            if (alertDetailsValue.alertDetails.alertDate !== "undefined") {
				...
				alertTimeWithDST = moment.utc(Number(alDate))._d;
                alertTime = moment(alertTimeWithDST).format('h:mmA');
				console.log("day light saving",moment(Number(alDate)).tz('America/New_York').isDST());
				if(moment(Number(alDate)).tz('America/New_York').isDST()){
					timeZone = "EDT";
				} else {
					timeZone = "EST";
            ...
            if (alertDetailsValue.userDetails.birthDate !== "undefined") {
                ...
                bDate = moment(bDay).tz('America/New_York').format('MMM D, YYYY');
            }
            if (alertType == "incidentalert") {
				if(alertDetailsValue.IncidentDetails.incidentState != undefined){
					residentialCity = alertDetailsValue.IncidentDetails.incidentCity+","+alertDetailsValue.IncidentDetails.incidentState;
					residentialCity = residentialCity.replace("undefined,","");
				} else if(alertDetailsValue.IncidentDetails.incidentCity != undefined){
                ...
                /* if (alertDetailsValue.IncidentDetails != undefined) {
                    if (alertDetailsValue.IncidentDetails.incidentCity != undefined || alertDetailsValue.IncidentDetails.incidentState != undefined) {
                        residentialCity = alertDetailsValue.IncidentDetails.incidentCity+","+alertDetailsValue.IncidentDetails.incidentState;
						residentialCity = residentialCity.replace("undefined,","");
                        try {
                            if (alertDetailsValue.IncidentDetails.incidentState != undefined) {
                                residentialCity = residentialCity + ", " + alertDetailsValue.IncidentDetails.incidentState;
                            }
                        } catch (e) {
				...
				residentialCity = alertDetailsValue.userDetails.residentialCity + ", " + alertDetailsValue.userDetails.residentialState;
                residentialCity.replace("undefined,","");
                /* if (alertDetailsValue.userDetails.residentialState != undefined) {
                    residentialCity = residentialCity + ", " + alertDetailsValue.userDetails.residentialState;
                } */
            }
            try {
            ...
            try {
			 ...
			 try {
                if (alertDetailsValue.userDetails.userId !== "undefined") {
                    feedUserId = alertDetailsValue.userDetails.userId;
                }
            } catch (e) {
                feedUserId = "";
            }
        ...
        if (HOMEPAGERESPONSE.ISVIEWEDARCHIVECLICKED) {
            ...
            viewArchiveFeedHTML = '<input style="z-index:10;" id=' + alertId + ' type="checkbox" class="checkbox snap" data-type="archiveCheckBox"><label id="home-feed" for=' + alertId + '></label>';
        }

        var sharedByName = "";
        var repNameFlag = 0;
		var sharedToName = "";
		var toShareNameFalg = 0;
		/* var sharedDate = "";
		var sharedTime = ""; */
        try {
			if(alertDetailsValue.alertShareDetails != undefined){
				if(alertDetailsValue.alertShareDetails.sharedByRole != "customer"){
					 repNameFlag = 1;
					 sharedByName = alertDetailsValue.alertShareDetails.sharedByName;
					 sharedTImeRef= alertDetailsValue.alertShareDetails.shareDate;
					 sharedDate = moment(Number(sharedTImeRef)).tz('America/New_York').format('MMM DD, YYYY');
					sharedTime = moment(Number(sharedTImeRef)).tz('America/New_York').format('h:mmA');
				} else {
					 repNameFlag = 0;
				}
				 if(alertDetailsValue.alertShareDetails.toUserNameList != undefined){
						 toShareNameFalg = 1;
						 var userNameList = alertDetailsValue.alertShareDetails.toUserNameList;
						 var lengthOfNameList = userNameList.length;
						 sharedToName = userNameList[lengthOfNameList-1];
						 sharedByName = alertDetailsValue.alertShareDetails.sharedByName;
						 sharedTImeRef= alertDetailsValue.alertShareDetails.sharedToTime;
						 sharedDate = moment(Number(sharedTImeRef)).tz('America/New_York').format('MMM DD, YYYY');
						 sharedTime = moment(Number(sharedTImeRef)).tz('America/New_York').format('h:mmA');
						 //sharedDate = moment(Number(sharedTImeRef)).format('MM DD, YYYY');
						//sharedTime = moment(Number(sharedTImeRef)).format('h:mmA');
					 } else {
						 toShareNameFalg = 0;
					 }
			}
           /*  if (alertDetailsValue.alertDetails.sharedNameAndTheirRole != undefined) {

                for (var index = 0; index < alertDetailsValue.alertDetails.sharedNameAndTheirRole.length; index++) {

                    var repName = alertDetailsValue.alertDetails.sharedNameAndTheirRole[index];


                    if (localStorage.getItem("LOGIN_LABEL") == "Agency") {
                        if (repName.indexOf("agencyrepresentative") > -1) {
                            repNameLists += repName.substring(0, repName.indexOf("@")) + ",";
                            repNameFlag = 1;
                        }
                    } else {
                        if (repName.indexOf("carrierrepresentative") > -1) {
                            repNameLists += repName.substring(0, repName.indexOf("@")) + ",";
                            repNameFlag = 1;
                        }
                    }
        ...
        if (localStorage.getItem("LOGIN_LABEL") == "Carriers") {
            ...
            if (alertDetailsValue.alertDetails.agencyName != undefined) {
                agencyName = '<div class="p-relative inline-block opensans-regular v-align-bot f-sz-12 feed-time t-upper" style="">' + alertDetailsValue.alertDetails.agencyName + '</div>';
            }
        ...
        rightSideAlerFeedHTML = '<div class="lf-block left" >'
                + '<div class="leftblk-spacing" style="padding-right:7px;">'
                + '<div class="feed-det bg-color-dblue p-relative  " ' + styleValue + '>'
                + '<div class="feed-det-pad p-relative">'
                + '<div class="feed-pic-b inline-block v-align-mid">' + '<div class="feed-user-pic-box">'
                + viewArchiveFeedHTML
                + '<img src="' + profilePicture + '" alt="" class="feeduserpic">'
                + '</div>'
                + '</div>'
                + '<div class="feed-user-det-b inline-block v-align-mid">'
                + '<div class="top-b p-relative" style="width:90%;">'
                + '<div class="p-relative inline-block v-align-top">'
                + '<div class="sprite-im mobile-icon mobile-icon-pos">&nbsp;</div>'
                + '</div>'
                + '<div class="p-relative inline-block opensans-regular v-align-bot f-sz-16 cust-name t-caps" style="margin-left:9px;  font-size: 17px;">' + firstName + ' ' + lastName + '</div>'
                + agencyName + '<div class="p-relative inline-block opensans-regular v-align-bot f-sz-12 feed-time t-upper" style="">' + alertTime + '<span style="margin-left:5px;">['+timeZone+']</span></div>'
                + '<div class="p-relative inline-block opensans-regular v-align-bot f-sz-13 alert-color alert-type t-caps" style="">' + alertType + '</div>';

        if (repNameFlag == 1) {
            rightSideAlerFeedHTML += '<div class="sprite-im inline-block sharedby-icon" style="margin-bottom:1px;">&nbsp;</div><div title="'+ sharedDate+"-"+sharedTime+'" class="p-relative inline-block opensans-regular v-align-bot f-sz-13  alert-type t-caps" style=" font-family: OpenSansSemibold;  cursor: pointer; margin-left: 5px; text-overflow: ellipsis;  color: #4c4c4c;">' + sharedByName + '</div>'
            //repNameFlag = 0;
        }
		if(toShareNameFalg == 1){
			rightSideAlerFeedHTML += '<span><div class="sprite-im inline-block sharedto-icon" style="margin-bottom:1px;">&nbsp;</div><div title="'+ sharedDate+"-"+sharedTime+'" class="p-relative inline-block opensans-regular v-align-bot f-sz-13  alert-type t-caps" style=" font-family: OpenSansSemibold;  cursor: pointer; margin-left: 5px; text-overflow: ellipsis;  color: #4c4c4c;">' + sharedToName + '</div></span>'
		}
        rightSideAlerFeedHTML += '</div>'
                + '<div class="bot-b" style="width:103%;margin-left:0px;">'
                + '<div class="p-relative inline-block v-align-bot" style="">'
                ...
                + '</div>' + '<div class="p-relative inline-block v-align-bot">';
        if (residentialCity != "") {
			//residentialCity = residentialCity.replace("undefined","");
            rightSideAlerFeedHTML += '<div class="sprite-im map-icon map-icon-pos" style="float:left;">&nbsp;</div>' + '<div class="p-relative inline-block opensans-regular v-align-bot f-sz-12 feed-location t-caps" style="float:left;margin-left:5px;">' + residentialCity + '</div>';
        }
        rightSideAlerFeedHTML += '</div>'
                + '<div class="p-relative inline-block v-align-bot">';
        if (phoneNumber != "") {
            rightSideAlerFeedHTML += '<div class="sprite-im phone-icon phone-icon-pos" style="float:left;">&nbsp;</div>'
                    + '<div id="id-custphone" class="p-relative inline-block opensans-regular v-align-bot f-sz-12 cust-phone t-caps" style="float:left;margin-left:10px;">' + phoneNumber + '</div>';
        }

        rightSideAlerFeedHTML += '</div>' + '<div class="p-relative inline-block v-align-bot">'
                + '<div class="sprite-im email-icon email-icon-pos" style="float:left;">&nbsp;</div>'
                + '<div id="id-custemail" title=' + feedUserEmail + ' class="p-relative inline-block opensans-regular v-align-bot f-sz-12 cust-email no-right-margin" style="float:left;margin-left:5px;  text-overflow: ellipsis;  margin-top: -3px;">' + feedUserEmail + '</div>'
                + '</div>' + '</div>'
                + '</div>'
                + '<div class="feed-user-share-b inline-block v-align-mid" style="">'
                + '<div class="myshare">'
                ...
                + '</div>'
                + '<div class="myview">'
                + '<div class="inner-view-spacing snap" data-type="view">' + '<div class="t-center mid-align">'
                + '<div class="sprite-im inline-block v-align-mid view-icon">&nbsp;</div>'
                + '<span class="feed-menu-text inline-block v-align-mid f-color-w" name=' + alertId + ' id=' + feedUserId + '>View</span>'
                + '</div>'
                + '</div>'
                + '</div>'
                + '</div>'
    ...
    CarrierfeedsTemplateHTML: function (c) {
        var html = '<div class="carrier-profile-screen left border-all p-relative"><div class="carrier-logo p-relative opensans-regular"><div class="carrierlogo-pic"><img src="' + profilePicture + '" alt="" class="carrier-img-width"></div> </div> <div class="carrier-info bg-color-white p-relative carrier-groupblock opensans-regular"> '
                + '<div class="carrier-name t-caps t-center" style="  margin-top: -7px;">' + c.carrierName + '</div> <div class="carrier-location t-caps t-center">' + c.state + '</div> <div class="carrier-email t-center">' + cEmail + '</div></div> <div class="carrier-view p-relative bg-color-green t-caps t-center opensans-light f-color-w snap" data-type="viewcarrierfeedview">view </div></div>';
        return html;
    },
    ...
    agencyProfiletemplate: function () {
        var html = '<div class="agenyparent-class bg-color-white"><div class="p-relative"><div class="agenyleft-profile inline-block v-align-mid p-relative"><div class="agenyleft-image border-all">'
                ...
                + '<div class="v-align-mid opensans-regular text-color-overlay f-sz-12 p-relative"><div class="sprite-im calendar-icon inline-block">&nbsp;</div>' + '<div class="t-upper inline-block">Change Image</div>'
